...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Clientes',
            'route'  => 'panel.administracion.clientes.index',
            'active' =>['panel/administracion/clientes*'],
            'can' => 'panel.administracion.clientes.index',
            'icon' => 'fas fa-fw fa-user',
        ],
        [
            'text' => 'Ventas',
            'route'  => 'panel.administracion.ventas.index',
            'active' =>['panel/administracion/ventas*'],
            'can' => 'panel.administracion.ventas.index',
            'icon' => 'fas fa-fw fa-shopping-cart',
        ],
        [
            'text' => 'Productos',
            'route'  => 'panel.administracion.productos.index',
            'active' =>['panel/administracion/productos*'],
